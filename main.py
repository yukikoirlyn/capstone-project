     ...
     di beberapa negara terjadi begitu signifikan, seperti di Prancis, Italia, dan Jerman. Kenaikan\
        signifikan juga terjadi di negara tetangga, Singapura. Kabar baiknya, Indonesia menempati\
            posisi terendah pada kasus harian terhadap populasi, jika dibandingkan beberapa negara\
                tetangga lainnya.\
                    Di tengah peningkatan kasus yang terjadi, hal ini tentu sangat mengkhawatirkan, \
                        mengingat antibodi masyarakat akan semakin berkurang.\
                                </div>', unsafe_allow_html=True)
st.markdown("---")
st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;">Laporan Peduli Lindungi</div>', unsafe_allow_html=True)
st.markdown('<br>', unsafe_allow_html=True)
col1, col2, col3 = st.columns([1,1,1])
with col1:
    st.markdown('<div style="text-align: center;font-size:70px;font-weight:bold;">1,9 jt</div>', unsafe_allow_html=True)  
    st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;">orang</div>', unsafe_allow_html=True)
    st.markdown('<div style="text-align: center;font-size:20px;font-weight:bold;">per hari</div>', unsafe_allow_html=True)
with col2:
    st.markdown('<div style="text-align: center;font-size:20px;font-weight:bold;">Pergi ke Mall</div>', unsafe_allow_html=True)
    st.image(image2,caption="source: freepik.com")
with col3:
    st.markdown('<div style="text-align: center;font-size:20px;font-weight:bold;">Hanya</div>', unsafe_allow_html=True)
    st.markdown('<div style="text-align: center;font-size:50px;font-weight:bold;">24,6 %</div>', unsafe_allow_html=True)  
    st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;">booster</div>', unsafe_allow_html=True)                                   
st.markdown('<br>', unsafe_allow_html=True)
st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;line-height:2.5;">Kebijakan Pemerintah</div>', unsafe_allow_html=True)
st.markdown('<div style="text-align:center;font-size:20px;">Vaksinasi booster efektif menjadi syarat perjalanan per 17 Juli 2022.\
...
st.markdown('<br>', unsafe_allow_html=True)
st.markdown('<div style="text-align:center;font-size:20px;font-weight:bold;">"Syarat vaksin booster untuk perjalanan\
    dinilai tidak akan mengganggu momentum\
        pemulihan ekonomi yang sedang berjalan.\
            Alasannya saat ini kesadaran masyarakat\
                untuk mendapatkan vaksin sudah\
                    terbangun dan cukup baik."\
                </div>', unsafe_allow_html=True)
st.markdown('<div style="text-align:center;font-size:18px;">EKO LISTYANTO</div>', unsafe_allow_html=True)
st.markdown('<div style="text-align:center;font-size:15px;">WAKIL DIREKTUR INDEF</div>', unsafe_allow_html=True)
st.markdown('<br>', unsafe_allow_html=True)
st.markdown("---")
col1, col2 = st.columns([1,4])
with col1:
    st.markdown('<div style="text-align:center;font-size:60px;">Lalu?\
                </div>', unsafe_allow_html=True)
with col2:
    st.markdown('<div style="text-align:justify;font-size:20px;">Apakah kebijakan vaksin  booster tidak mempengaruhi mobilitas masyarakat?\
...
st.markdown('<br>', unsafe_allow_html=True)
st.markdown('<div style="text-align: center;font-size:27px;">Mobilitas Masyarakat Indonesia saat Pandemi</div>', unsafe_allow_html=True)
# dataset declaration
...
st.markdown('<div style="text-align: justify;font-size:20px;font-weight:bold;">Hal yang cukup menarik \
    terasa pada dua kondisi:</div>', unsafe_allow_html=True)
st.markdown('<div style="text-align: justifi;font-size:20px;">1. Pada saat kasus \
    covid meningkat\
        </div>', unsafe_allow_html=True)
st.markdown('<div style="text-align: justify;font-size:20px;">2. Pada saat libur nasional. \
    </div>', unsafe_allow_html=True)
st.markdown('<div style="text-align: justify;font-size:20px;">Diketahui terdapat tiga gelombang \
...
# heat map
st.markdown('<div style="text-align: center;font-size:27px;">Heat Maps perubahan Mobilitas Masyarakat berdasarkan Sektornya</div>', unsafe_allow_html=True)
st.markdown('<br>', unsafe_allow_html=True)
...
st.markdown('<div style="text-align:justify;font-size:20px;">Data menjelaskan di lokasi park \
    semester awal tahun 2022 memiliki sesuatu yang unik terlihat pada musim lebaran, \
        nilai mobilisasi masyarakat cukup tinggi. Pada musim liburan saat itu, umumnya masyarakat \
            lebih memilih ke tempat yang outdoor ketimbang harus ke dalam mall.\
                Sedangkan peraturan pemerintah berlaku di stasiun, bandara, maupun pelabuhan.\
                    Sehingga, \
                        kebijakan pemerintah disini membatasi masyarakat untuk melakukan mobilitas bisa\
                            dikatakan tidak berlaku.</div>', unsafe_allow_html=True)

st.write("")
st.markdown("---")

st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;">Analisis Korelasi</div>', unsafe_allow_html=True)
st.markdown('<br>', unsafe_allow_html=True)

st.markdown('<div style="text-align: center;font-size:27px;">Korelasi antara Mobilitas \
...
st.markdown('<div style="text-align: justify;font-size:20px;">Melalui data di atas, \
    dapat menunjukkan bahwa sangat erat kaitannya antara mobilitas\
        masyarakat dengan pertumbuhan ekonomi. Namun, terdapat hal yang unik pada data di \
...
st.markdown('<br>', unsafe_allow_html=True)
st.markdown('<div style="text-align: center;font-size:27px;">Produk Domestik Bruto \
...
st.markdown('<div style="text-align: justify;font-size:20px;">Kontribusi terbesar dalam perekonomian Indonesia terdapat pada sektor industri\
    pengolahan. Berdasarkan data tersebut, penyimpangan yang terjadi pada triwulan 4 2021 dan \
        triwulan 1 2022 secara signifikan disebabkan oleh jasa kesehatan dan kegiatan sosial.</div>', unsafe_allow_html=True)
st.markdown("---")
st.markdown('<div style="text-align: center;font-size:30px;font-weight:bold;">Korelasi antara Kenaikan \
...
st.markdown('<div style="text-align: justify;font-size:20px;">Terdapat korelasi yang kuat antara total vaksinasi \
...
st.markdown("---")
st.markdown('<div style="text-align:justify;font-size:40px;">Recommendation\
                </div>', unsafe_allow_html=True)
st.markdown('<div style="text-align: justify;font-size:20px;">Varian Covid yang \
                        ...
                        Berdasarkan data yang telah disajikan, wawasan yang dapat diberikan bahwa pemerintah \
                            harus lebih kreatif dalam memberikan kampanye karena kesadaran masyarakat saat ini \
                                cukup baik untuk diberikan vaksin, meski mobilitas sangat berkorelasi dengan \
                                    pertumbuhan ekonomi. Namun perlu diingat, bekerja melalui WFH (Work From Home) juga dapat \
...
st.markdown("---")
st.markdown('<div style="text-align:center;font-size:17px;">Sumber Data:\
    GOOGLE Community Mobility Report, Produk Domestik Bruto (PDB) menurut Lapangan Usaha by Badan\
        Pusat Statistika (BPS), Total Vaccination by Our World in Data\
                </div>', unsafe_allow_html=True)
